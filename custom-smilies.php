...
function cs_add_pages() {
    add_management_page('Manage smilies', 'Smilies', 8, basename(__FILE__), cs_manage_smilies);
    add_options_page('Smilies Options', 'Smilies', 8, basename(__FILE__), cs_options);
}
